                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <a href="{{route('add-donate')}}" class="btn btn-primary ms-text-primary">Add Donate</a>
                                ...
                                <table id="datatable" class="display compact table table-striped table-bordered" >
                                    ...
                                    @foreach($donate as $items)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('delete-donate',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Delete" class="ti ti-trash text-danger"> </a>

                                                <a href="{{route('edit-donate',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Edit" class="ti ti-pencil text-primary"> </a>
                                            </td>
