                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <a href="{{route('add-footer')}}" class="btn btn-primary ms-text-primary">Add Footer</a>
                                ...
                                <table id="datatable" class="display compact table table-striped table-bordered" >
                                    ...
                                    @foreach($footer as $items)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('delete-footer',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Delete" class="ti ti-trash text-danger"> </a>

                                                <a href="{{route('edit-footer',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Edit" class="ti ti-pencil text-primary"> </a>
                                            </td>
