                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <a href="{{route('add-gdprcompliance')}}" class="btn btn-primary ms-text-primary">Add GDPR Compliance </a>
                        ...
                        <div class="card-body">
                            <div class="datatable-wrapper table-responsive">
                                <table id="datatable" class="display compact table table-striped table-bordered" >
                                    ...
                                    @foreach($gdprcompliance as $items)
                                        <tr>
                                            <td>{{$items->id}}</td>
                                            ...
                                            <td>
                                                @if($items->g_image)
                                                    ...
                                                    <img src="{{ asset($items->g_image) }}" width="70px" height="70px"
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('edit-gdprcompliance',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Edit" class="ti ti-pencil text-primary"> </a>
                                            </td>
