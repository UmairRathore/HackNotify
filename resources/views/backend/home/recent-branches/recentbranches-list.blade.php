                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <a href="{{route('add-recentbranches')}}" class="btn btn-primary ms-text-primary">Add Recent Branches</a>
                        ...
                        <div class="card-body">
                            <div class="datatable-wrapper table-responsive">
                                <table id="datatable" class="display compact table table-striped table-bordered" >
                                    ...
                                    @foreach($recentbranches as $items)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('delete-recentbranches',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Delete" class="ti ti-trash text-danger"> </a>

                                                <a href="{{route('edit-recentbranches',$items->id)}}" data-toggle="tooltip" data-placement="top" title="Edit" class="ti ti-pencil text-primary"> </a>
                                            </td>
