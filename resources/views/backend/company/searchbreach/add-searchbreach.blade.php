                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-statistics">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('add-searchbreach')}}" enctype="multipart/form-data">
                                @csrf
...
{{--                                                    {{dd($items)}}--}}
                                                    <option value="{{$items->id}}" @if($items->id==old('company_id')) selected @endif>{{$items->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('company_id')
